...
- 60 ft, 100 m, 201 m, 301 m, and 402 m splits.
- 0–60, 0–100, and 0–120 km/h metrics when the trace supports them.
- Trap-speed and start-model evidence where available.
- GPS readiness, sample quality, telemetry evidence, and two-way context.

## What it adds

- Local run history and personal best.
